...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShelfRelation'
        db.create_table('medialibrary_shelfrelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('shelf', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relationships', to=orm['medialibrary.Shelf'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('medialibrary', ['ShelfRelation'])


    def backwards(self, orm):
        # Deleting model 'ShelfRelation'
        db.delete_table('medialibrary_shelfrelation')
