...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Audio.content_type'
        db.add_column('medialibrary_audio', 'content_type',
                      self.gf('django.db.models.fields.CharField')(default='application/octet-stream', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Video.content_type'
        db.add_column('medialibrary_video', 'content_type',
                      self.gf('django.db.models.fields.CharField')(default='application/octet-stream', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Image.content_type'
        db.add_column('medialibrary_image', 'content_type',
                      self.gf('django.db.models.fields.CharField')(default='application/octet-stream', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Audio.content_type'
        db.delete_column('medialibrary_audio', 'content_type')

        # Deleting field 'Video.content_type'
        db.delete_column('medialibrary_video', 'content_type')

        # Deleting field 'Image.content_type'
        db.delete_column('medialibrary_image', 'content_type')
