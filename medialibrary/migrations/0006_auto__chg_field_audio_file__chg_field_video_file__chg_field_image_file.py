...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('medialibrary_audio', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'Video.file'
        db.alter_column('medialibrary_video', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'Image.file'
        db.alter_column('medialibrary_image', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Audio.file'
        db.alter_column('medialibrary_audio', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Video.file'
        db.alter_column('medialibrary_video', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Image.file'
        db.alter_column('medialibrary_image', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
